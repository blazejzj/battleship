...
class MessageManager {
  constructor() {
    this.messages = {
      ...
      enemyMiss: [
        'Missed me, missed me!',
        'That shot went wide. Your luck is holding, Captain.',
        "They can't hit us, Captain! We’re too good!",
        'Another miss from the enemy! They’re losing their touch.',
        'Their aim was off! We’re safe, Captain.',
        "They didn't land that one. We’re still in the fight.",
        "They missed again! Let’s show them how it’s done.",
        'The enemy can’t seem to hit us. We’ve got the upper hand!',
        'Another enemy shot, another miss. We’ve got this!',
        'They missed! Now it’s our turn to strike.',
      ],
      noComment: ['...'],
      playerWin: [
